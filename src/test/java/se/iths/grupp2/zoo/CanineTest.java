...
class CanineTest {
    ...
    private final se.iths.grupp2.zoo.animals.canine.Wolf Wolf = new Wolf("Wolf", Arrays.asList(Food.MEAT), 0, false, true);
    private final se.iths.grupp2.zoo.animals.canine.Coyote Coyote = new Coyote("Coyote", Arrays.asList(Food.MEAT), 0, true, false);
    private final se.iths.grupp2.zoo.animals.canine.Dog Dog = new Dog("Dog", Arrays.asList(Food.MEAT), 0, true, true);
